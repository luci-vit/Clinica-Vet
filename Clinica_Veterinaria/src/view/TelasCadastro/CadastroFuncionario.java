		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(isAVeterinarian) {
					...
					//String id, String nome, String cpf, String email, String telefone, String turnoTrabalho, String funcao, String cfmv, String especialidade
					Veterinario dadosVeterinario = new Veterinario(null, textFieldNome.getText(), textFieldCpf.getText(), textFieldEmail.getText(), 
							textFieldTelefone.getText(), textFieldTurnoDeTrabalho.getText(), textFieldFuncao.getText(), textFieldCFMV.getText(), 
							textFieldEspecialidade.getText());
					if (funcionario==null) {
						daoVeterinario.efetuarCadastro(dadosVeterinario);
					} else {
						daoVeterinario.editarDados(dadosVeterinario, funcionario.getId());
					}
				}else {
					DAOFuncionario daoFuncionario = new DAOFuncionario();
					Funcionario dadosFuncionario = new Funcionario(null, textFieldNome.getText(), textFieldCpf.getText(), 
							textFieldEmail.getText(), textFieldTelefone.getText(), textFieldTurnoDeTrabalho.getText(),
							textFieldFuncao.getText());
					if(funcionario==null) {
		...
		btnExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(funcionario != null) {
					...
					JOptionPane.showMessageDialog(btnExcluir, "Não é possível excluir um contribuidor que não foi cadastrado");
				}
			}
		});
